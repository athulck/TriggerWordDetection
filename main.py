...
Thus, a 10 second audio clip is represented by 441000 numbers.
...
This means that for the output of the model, we discretize the 10s into 1375 time-intervals (each one of length 10/1375≈0.0072s) and try to predict for each of these intervals whether someone recently finished saying "activate." 
"""
...
model = GRUModel(input_shape = (Tx, n_freq))         #(5511, 101)
...
model.fit(X, Y, batch_size = 5, epochs=5)   #1 epoch
